...
## Aula 05.09 - Atribuindo o objeto da composi��o
Quando utilizamos composi��o de objetos, o objeto referenciado precisa ser instanciado antes de tentarmos acessar suas propriedades, ou ocorrer� um NullPointerException.

## Aula 05.10 - Conhecendo o diagrama de classes da UML
O diagrama de classes fornece uma representa��o visual da estrutura do sistema. Usamos ret�ngulos para representar classes e linhas para representar associa��es/composi��es. O StarUML � uma das ferramentas utilizadas para cri�-los.
